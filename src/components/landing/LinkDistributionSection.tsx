...
import { 
  ...
  Trash2, ExternalLink, Send, Crown
} from 'lucide-react';
    ...
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-5/12 space-y-8">
              <div className="relative">
                <div className="absolute -top-10 left-0 h-40 w-40 rounded-full bg-blue-500/20 blur-[100px] pointer-events-none"></div>
                <span className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-2 block relative z-10">Distribuire & Acces</span>
                <h2 className="wp-section-title2 text-4xl md:text-5xl font-black text-white mb-6 leading-tight relative z-10">
                  <BlurText text="Un Link."
                          ...
                          /><br/>
                  Sau sute de <span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(180deg, #60a5fa 0%, #7c3aed 100%)' }}>link-uri.</span>
                </h2>
      ...
      <section className="relative overflow-hidden px-4 pb-8 pt-8 md:pt-12">
        ...
        <div className="wp-container relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-8 md:mb-12 relative">
            ...
            <h2 className="wp-section-title2 text-4xl md:text-5xl font-black text-white mb-6 leading-tight relative z-10">
              ...
              <br />Platforma WeddingPro are raspunsurile.
            </h2>
            <p className="text-gray-400 text-lg md:text-xl font-light relative z-10">
              De la link public si RSVP pana la informatiile importante din invitatie, totul sta intr-un singur loc usor de parcurs.
            </p>
          </div>
        </div>
      </section>
