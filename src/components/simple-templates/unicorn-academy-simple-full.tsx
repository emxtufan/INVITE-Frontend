...
import { getUnicornTheme } from "../invitations/castleDefaults";
...
const UnicornAcademyTemplate: React.FC<UnicornAcademyTemplateProps> = ({
  ...
  const l1 = (profile.partner1Name || profile.eventName || "Invitat").trim();
...
export const CASTLE_DEFAULT_BLOCKS: InvitationBlock[] = getSharedDefaultBlocks("unicorn-academy-simple");
