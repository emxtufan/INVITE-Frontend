...
export const meta: TemplateMeta = {
  id: "royal-rose-editorial-simple",
  name: "Royal Rose Editorial",
  category: "wedding",
  description:
    "Design minimalist premium, inspirat de estetica Apple, fara intro.",
  colors: ["#111111", "#d1d5db", "#f5f5f7"],
  previewClass: "bg-stone-50 border-stone-200",
  elementsClass: "bg-stone-200",
};
    ...
    >
      <div
        style={{
          ...panelBase,
          left: 0,
          background: `linear-gradient(135deg, ${T.PINK_DARK} 0%, #0d0d0d 100%)`,
      ...
      <div
        style={{
          ...panelBase,
          right: 0,
          background: `linear-gradient(225deg, ${T.PINK_DARK} 0%, #0d0d0d 100%)`,
...
const BlockToolbar = ({
  ...
  <div className="absolute -top-3.5 right-3 flex items-center gap-0.5 bg-white border border-stone-200 rounded-full shadow-lg px-1.5 py-1 opacity-0 group-hover/block:opacity-100 transition-all z-30 pointer-events-none group-hover/block:pointer-events-auto">
    <button
      ...
      disabled={isFirst}
      className="p-0.5 rounded-full hover:bg-stone-50 disabled:opacity-25 transition-colors"
    >
    ...
    <button
      ...
      className="p-0.5 rounded-full hover:bg-stone-50 transition-colors"
    >
      {visible ? (
            ...
            <>
              ...
              <div className="absolute inset-0 bg-black/20 hover:bg-black/35 transition-colors flex items-center justify-center gap-2">
                ...
                <button
                  ...
                  className="p-2 bg-white rounded-full text-red-600 shadow-sm"
                >
          ...
          return (
            <div
              ...
              style={{
                ...
                color: isToday ? "white" : cell ? T.PINK_DARK : "transparent",
                background: isToday ? T.PINK_DARK : "transparent",
              }}
            >
              {cell || ""}
            </div>
...
export type RoyalRoseEditorialProps = InvitationTemplateProps & {
  editMode?: boolean;
...
const RoyalRoseEditorialTemplate: React.FC<RoyalRoseEditorialProps> = ({
  data,
  onOpenRSVP,
  editMode = false,
  introPreview = false,
  ...
  const themeCSS = `
    ...
    .re-wrap .re-apple-shell {
      ...
      border-radius: 36px;
      box-shadow: 0 24px 80px rgba(15,23,42,0.10), 0 6px 24px rgba(15,23,42,0.06);
  ...
  return (
    <div
      ...
      style={{
        background: `radial-gradient(circle at top, rgba(255,255,255,0.92) 0%, ${T.PINK_XL} 38%, ${T.CREAM} 100%)`,
        fontFamily: APPLE_DISPLAY_FONT,
      }}
    >
        ...
        <div className="max-w-3xl w-full">
          ...
          <div className="re-apple-shell" style={{ padding: "0 0 2px" }}>
            <div
              ...
              style={{
                background: `linear-gradient(90deg, rgba(255,255,255,0.35), ${T.PINK_L}, ${T.PINK_D}, rgba(255,255,255,0.35))`,
                borderTopLeftRadius: 36,
                borderTopRightRadius: 36,
              }}
            />

            <div className="px-6 md:px-14 pt-10 pb-10 text-center space-y-9">
              <BlockStyleProvider
                value={{
                  blockId: "__hero__",
            ...
            <div className="h-px w-full mt-2" style={{ background: `${T.PINK_L}99` }} />
            <div
              className="h-1.5 w-full"
              style={{
                background: `linear-gradient(90deg, rgba(255,255,255,0.35), ${T.PINK_L}, ${T.PINK_D}, rgba(255,255,255,0.35))`,
...
export default RoyalRoseEditorialTemplate;
