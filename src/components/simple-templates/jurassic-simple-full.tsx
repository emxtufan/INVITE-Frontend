...
import { getJurassicTheme } from "../invitations/castleDefaults";
...
export const CASTLE_DEFAULT_BLOCKS: InvitationBlock[] = getSharedDefaultBlocks("jurassic-park-simple");
