...
import { getZootropolisTheme } from "../invitations/castleDefaults";
...
const CityDoorIntro: React.FC<{
  editMode?: boolean; previewMode?: 'doors' | 'static'; embeddedPreview?: boolean;
  ...
  editMode, previewMode = 'doors', embeddedPreview = false, contentEl, scrollContainer,
...
export const CASTLE_DEFAULT_BLOCKS: InvitationBlock[] = getSharedDefaultBlocks("zootropolis-simple");
  ...
  if (introOnly) {
    return (
      <div style={{ background: C.city }}>
        <style dangerouslySetInnerHTML={{ __html: ZT_CSS + ' html,body{background:' + C.city + '!important;}' }}/>
        <div
          style={{
