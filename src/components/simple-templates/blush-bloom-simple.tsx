...
import { BLUSH_BLOOM_THEMES } from "../invitations/castleDefaults";
import BlushBloomSimpleFull from "./blush-bloom-simple-full";
import { SimplePalette, SimpleTemplateRenderProps } from "./types";

export const BLUSH_BLOOM_SIMPLE_PALETTES: SimplePalette[] = BLUSH_BLOOM_THEMES.map(
  (theme) => ({
    id: theme.id,
...
const BlushBloomSimpleTemplate: React.FC<SimpleTemplateRenderProps> = ({
  data,
  onOpenRSVP,
  editMode = false,
  introOnly = false,
...
export default BlushBloomSimpleTemplate;
