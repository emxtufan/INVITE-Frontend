...
import { getAdventureTheme } from "../invitations/castleDefaults";
...
const RoadIntro: React.FC<{ initial:string; name:string; onDone:()=>void }> = ({ initial, name, onDone }) => {
  ...
  // 01 sky+road | 2 plane flies in | 3 car drives in | 4 rocket launches | 5 initial pops | 6 name | 7 hold | 8 fade
...
export const CASTLE_DEFAULT_BLOCKS: InvitationBlock[] = getSharedDefaultBlocks("adventure-road-simple");
                  ...
                  {block.type === 'rsvp' && (
                    <button onClick={() => onOpenRSVP && onOpenRSVP()} style={{
                      ...
                      <InlineEdit
                        ...
                        onChange={(v) => updBlock(idx, { label: v.trim() })}
